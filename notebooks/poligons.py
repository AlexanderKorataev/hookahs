...
class VideoProcessor:
    def __init__(
        ...
        self.zones_in = initiate_polygon_zones(
            ZONE_IN_POLYGONS, self.video_info.resolution_wh, [
                sv.Position.CENTER]
        )
        self.zones_out = initiate_polygon_zones(
            ZONE_OUT_POLYGONS, self.video_info.resolution_wh, [
                sv.Position.CENTER]
        )
    ...
    def annotate_frame(
        ...
        labels = [f"#{tracker_id} {conf:.2f}" for tracker_id,
                  conf in zip(detections.tracker_id, detections.confidence)]
...
if __name__ == "__main__":
    ...
    processor = VideoProcessor(
        source_weights_path='./models/yolo/hookahs_v0.3_n_Epochs_80.pt',
        source_video_path='./cropped_video.mp4',
        target_video_path='./crop1.avi',
